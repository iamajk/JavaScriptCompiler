!(function (e, t) {
        ...
        pe =
            ...
            function (e, t) {
                ...
                for (var r, i = e.length, o = [], l = 0; l < i; ++l)
                    o.push((r = e.charCodeAt(l)) <= 247 ? se.charAt(r) : 1424 <= r && r <= 1524 ? "R" : 1536 <= r && r <= 1785 ? ae.charAt(r - 1536) : 1774 <= r && r <= 2220 ? "r" : 8192 <= r && r <= 8203 ? "w" : 8204 == r ? "b" : "L");
                ...
                for (var c = 0, h = n; c < i; ++c) {
                    var d = o[c];
                    "1" == d && "r" == h ? (o[c] = "n") : he.test(d) && "r" == (h = d) && (o[c] = "R");
                }
                ...
                return (
                    "ltr" == t &&
                        (1 == A[0].level && (O = e.match(/^\s+/)) && ((A[0].from = O[0].length), A.unshift(new ge(0, 0, O[0].length))),
                        1 == Y(A).level && (O = e.match(/\s+$/)) && ((Y(A).to -= O[0].length), A.push(new ge(0, i - O[0].length, i)))),
                    "rtl" == t ? A.reverse() : A
                );
            });
    function ge(e, t, n) {
    ...
    function we(e, t, n) {
        var r;
        e.removeEventListener ? e.removeEventListener(t, n, !1) : e.detachEvent ? e.detachEvent("on" + t, n) : !(e = (r = e._handlers) && r[t]) || (-1 < (n = z(e, n)) && (r[t] = e.slice(0, n).concat(e.slice(n + 1))));
    }
    function xe(e, t) {
        var n = be(e, t);
    ...
    var Pe =
        ...
        Ie = "oncopy" in (r = M("div")) || (r.setAttribute("oncopy", "return;"), "function" == typeof r.oncopy),
        ze = null;
    var Re = {},
        Be = {};
    function Ge(e) {
    ...
    function Je(e) {
        ...
        for (var t = e.parent, n = z(t.lines, e), r = t.parent; r; r = (t = r).parent) for (var i = 0; r.children[i] != t; ++i) n += r.children[i].chunkSize();
        return n + t.first;
    }
    function et(e, t) {
        var n = e.first;
    ...
    function ct(e, t) {
        ...
        return t.line > n ? rt(n, $e(e, n).text.length) : ((e = $e(e, (n = t).line).text.length), null == (t = n.ch) || e < t ? rt(n.line, e) : t < 0 ? rt(n.line, 0) : n);
    }
    function ht(e, t) {
    ...
    (_e.prototype.eol = function () {
        ...
        (_e.prototype.column = function () {
            return (
                this.lastColumnPos < this.start && ((this.lastColumnValue = E(this.string, this.start, this.tabSize, this.lastColumnPos, this.lastColumnValue)), (this.lastColumnPos = this.start)),
    ...
    function vt(e, t, n, r) {
        ...
        for (o.start = o.pos = r || 0, "" == t && yt(i, n.state); !o.eol(); ) bt(i, o, n.state), (o.start = o.pos);
    }
    function yt(e, t) {
    ...
    (ft.prototype.lookAhead = function (e) {
        ...
        (ft.fromSaved = function (e, t, n) {
            return t instanceof dt ? new ft(e, je(e.mode, t.state), n, t.lookAhead) : new ft(e, je(e.mode, t), n);
        }),
    ...
    function xt(e, t, n, r) {
        ...
        for (r && (o = []); (r || c.pos < t.ch) && !c.eol(); ) (c.start = c.pos), (i = bt(s, c, u.state)), r && o.push(new wt(c, i, je(l.mode, u.state)));
    ...
    function St(e, t, n, r, i, o, l) {
        ...
        for ("" == t && Ct(yt(n, r.state), o); !c.eol(); ) {
            var d,
                f = c.pos > e.options.maxHighlightLength ? ((s = !1), l && vt(e, t, r, c.pos), (c.pos = t.length), null) : Ct(bt(n, c, r.state, h), o);
    ...
    function Nt(e, t) {
                ...
                if (e)
                    for (var i = 0; i < e.length; ++i) {
                        ...
                        (!(null == l.from || (s.inclusiveLeft ? l.from <= t : l.from < t)) && (l.from != t || "bookmark" != s.type || (n && l.marker.insertLeft))) ||
                            ((o = null == l.to || (s.inclusiveRight ? l.to >= t : l.to > t)), (r = r || []).push(new Tt(s, l.from, o ? null : l.to)));
                    }
                return r;
            })(n, i, e),
            s = (function (e, t, n) {
                ...
                if (e)
                    for (var i = 0; i < e.length; ++i) {
                        ...
                        (!(null == l.to || (s.inclusiveRight ? l.to >= t : l.to > t)) && (l.from != t || "bookmark" != s.type || (n && !l.marker.insertLeft))) ||
                            ((o = null == l.from || (s.inclusiveLeft ? l.from <= t : l.from < t)), (r = r || []).push(new Tt(s, o ? null : l.from - t, null == l.to ? null : l.to - t)));
                    }
                return r;
            })(r, o, e),
            a = 1 == t.text.length,
        ...
        if (l)
            for (var c = 0; c < l.length; ++c) {
                var h,
                    d = l[c];
                null == d.to && ((h = Mt(s, d.marker)) ? a && (d.to = null == h.to ? null : h.to + u) : (d.to = i));
            }
        if (s)
            for (var f = 0; f < s.length; ++f) {
                var p = s[f];
                null != p.to && (p.to += u), null == p.from ? Mt(l, p.marker) || ((p.from = u), a && (l = l || []).push(p)) : ((p.from += u), a && (l = l || []).push(p));
            }
        ...
        if (!a) {
            var m,
                v = t.text.length - 2;
            if (0 < v && l) for (var y = 0; y < l.length; ++y) null == l[y].to && (m = m || []).push(new Tt(l[y].marker, null, null));
    ...
    function Pt(e, t) {
        var n,
            r = kt && e.markedSpans;
        if (r) for (var i, o = 0; o < r.length; ++o) (i = r[o]).marker.collapsed && null == (t ? i.from : i.to) && (!n || Ft(n, i.marker) < 0) && (n = i.marker);
        return n;
    }
    function Et(e) {
        return Pt(e, !0);
        ...
        if (o)
            for (var l = 0; l < o.length; ++l) {
                ...
                if (s.marker.collapsed) {
                    ...
                    if (
                        !((0 <= u && c <= 0) || (u <= 0 && 0 <= c)) &&
                        ((u <= 0 && (s.marker.inclusiveRight && i.inclusiveLeft ? 0 <= it(a.to, n) : 0 < it(a.to, n))) || (0 <= u && (s.marker.inclusiveRight && i.inclusiveLeft ? it(a.from, r) <= 0 : it(a.from, r) < 0)))
                    )
                        return 1;
                }
            }
    ...
    function qt(e, t) {
        var n = N("span", null, null, f ? "padding-right: .1px" : null),
            r = { pre: N("pre", [n], "CodeMirror-line"), content: n, col: 0, pos: 0, cm: e, trailingSpace: !1, splitSpaces: e.getOption("lineWrapping") };
        t.measure = {};
            ...
            (r.pos = 0),
                ...
                (function (e, t, n) {
                    var r = e.markedSpans,
                        ...
                        o = 0;
                    if (!r) {
                        for (var l = 1; l < n.length; l += 2) t.addToken(t, i.slice(o, (o = n[l])), $t(n[l + 1], t.cm.options));
                        return;
                    }
                    for (var s, a, u, c, h, d, f, p = i.length, g = 0, m = 1, v = "", y = 0; ; ) {
                        if (y == g) {
                            ...
                            for (var b = [], w = void 0, x = 0; x < r.length; ++x) {
                                ...
                                if ("bookmark" == S.type && C.from == g && S.widgetNode) b.push(S);
                                    ...
                                    if (
                                        ...
                                        S.endStyle && C.to == y && (w = w || []).push(S.endStyle, C.to),
                                        S.title && ((f = f || {}).title = S.title),
                                        S.attributes)
                                    )
                                        for (var L in S.attributes) (f = f || {})[L] = S.attributes[L];
                                    S.collapsed && (!d || Ft(d.marker, S) < 0) && (d = C);
                                } else C.from > g && y > C.from && (y = C.from);
                            }
                            if (w) for (var k = 0; k < w.length; k += 2) w[k + 1] == y && (c += " " + w[k]);
                            if (!d || d.from == g) for (var T = 0; T < b.length; ++T) Jt(t, 0, b[T]);
                            if (d && (d.from || 0) == g) {
                                if ((Jt(t, (null == d.to ? p + 1 : d.to) - g, d.marker, null == d.from), null == d.to)) return;
                                d.to == g && (d = !1);
                            }
                        }
                        if (p <= g) break;
                        for (var M = Math.min(p, y); ; ) {
                            if (v) {
                                var N,
                                    O = g + v.length;
                                if ((d || ((N = M < O ? v.slice(0, M - g) : v), t.addToken(t, N, s ? s + u : u, h, g + N.length == y ? c : "", a, f)), M <= O)) {
                                    (v = v.slice(M - g)), (g = M);
                                    break;
                                }
                                (g = O), (h = "");
                ...
                o.styleClasses && (o.styleClasses.bgClass && (r.bgClass = W(o.styleClasses.bgClass, r.bgClass || "")), o.styleClasses.textClass && (r.textClass = W(o.styleClasses.textClass, r.textClass || ""))),
                0 == r.map.length &&
                    r.map.push(
                        0,
                        0,
                        r.content.appendChild(
                            (function (e) {
                                null == We && ((t = M("span", "​")), T(e, M("span", [t, document.createTextNode("x")])), 0 != e.firstChild.offsetHeight && (We = t.offsetWidth <= 1 && 2 < t.offsetHeight && !(w && v < 8)));
                                var t = We ? M("span", "​") : M("span", " ", null, "display: inline-block; width: 1px; margin-right: -1px");
        ...
        return (
            f && ((n = r.content.lastChild), (/\bcm-tab\b/.test(n.className) || (n.querySelector && n.querySelector(".cm-tab"))) && (r.content.className = "cm-tab-wrap-hack")),
        ...
        if (t) {
            ...
            if (u.test(t)) {
                ...
                for (var h = 0; ; ) {
                    ...
                    if ((f && ((p = document.createTextNode(a.slice(h, h + f))), w && v < 9 ? s.appendChild(M("span", [p])) : s.appendChild(p), e.map.push(e.pos, e.pos + f, p), (e.col += f), (e.pos += f)), !d)) break;
                    h += 1 + f;
                    var p = void 0;
                    "\t" == d[0]
                        ? ((f = (f = e.cm.options.tabSize) - (e.col % f)), (p = s.appendChild(M("span", X(f), "cm-tab"))).setAttribute("role", "presentation"), p.setAttribute("cm-text", "\t"), (e.col += f))
                        : ("\r" == d[0] || "\n" == d[0]
                              ? (p = s.appendChild(M("span", "\r" == d[0] ? "␍" : "␤", "cm-invalidchar"))).setAttribute("cm-text", d[0])
                              : ((p = e.cm.options.specialCharPlaceholder(d[0])).setAttribute("cm-text", d[0]), w && v < 9 ? s.appendChild(M("span", [p])) : s.appendChild(p)),
                          (e.col += 1)),
                        e.map.push(e.pos, e.pos + 1, p),
                        e.pos++;
                }
            } else (e.col += t.length), (s = document.createTextNode(a)), e.map.push(e.pos, e.pos + t.length, s), w && v < 9 && (c = !0), (e.pos += t.length);
        ...
        for (var i = 0; i < t.changes.length; i++) {
            ...
            "text" == o
                ? (function (e, t) {
                      ...
                      t.text.parentNode.replaceChild(r.pre, t.text), (t.text = r.pre), r.bgClass != t.bgClass || r.textClass != t.textClass ? ((t.bgClass = r.bgClass), (t.textClass = r.textClass), hn(e, t)) : n && (t.text.className = n);
                  })(e, t)
                : "gutter" == o
                ? dn(e, t, n, r)
                : "class" == o
    ...
    function hn(e, t) {
        ...
        (n = e),
            ...
            i.background
                ...
                : r && ((e = un(i)), (i.background = e.insertBefore(M("div", null, r), e.firstChild)), n.display.input.setUneditable(i.background)),
            t.line.wrapClass ? (un(t).className = t.line.wrapClass) : t.node != t.text && (t.node.className = "");
        ...
        if (e.options.lineNumbers || i) {
            ...
            if (
                ...
                !e.options.lineNumbers ||
                    ...
                    (t.lineNumber = l.appendChild(M("div", nt(e.options, n), "CodeMirror-linenumber CodeMirror-gutter-elt", "left: " + r.gutterLeft["CodeMirror-linenumbers"] + "px; width: " + e.display.lineNumInnerWidth + "px"))),
                i)
            )
                ...
                a.handleMouseEvents || u.setAttribute("cm-ignore-events", "true"),
                    (function (e, t, n, r) {
                        e.noHScroll &&
                            ...
                            e.coverGutter || ((n -= r.gutterTotalWidth), (t.style.paddingLeft = r.gutterTotalWidth + "px")),
                            (t.style.width = n + "px"));
    ...
    function Sn(e, t, n) {
        ...
        for (var i = 0; i < e.rest.length; i++) if (Je(e.rest[i]) > n) return { map: e.measure.maps[i], cache: e.measure.caches[i], before: !0 };
    }
    function Ln(e, t, n, r) {
    ...
    function Tn(e, t) {
        var n,
            ...
            i = Je(t),
            o = kn(e, i);
        o && !o.text ? (o = null) : o && o.changes && (an(e, o, i, $n(e)), (e.curOp.forceUpdate = !0)),
            o || ((n = e), (e = Je((r = Rt((r = t))))), ((r = n.display.externalMeasured = new en(n.doc, r, e)).lineN = e), (e = r.built = qt(n, r)), (r.text = e.pre), T(n.display.lineMeasure, e.pre), (o = r));
        i = Sn(o, t, i);
            ...
            t.cache.hasOwnProperty(l)
                ...
                : (t.rect || (t.rect = t.view.text.getBoundingClientRect()),
                  ...
                  (o = (function (e, t, n, r) {
                              ...
                              (i = (function (e, t) {
                                  if (
                                      ...
                                      !(function (e) {
                                          ...
                                          var e = (t = T(e, M("span", "x"))).getBoundingClientRect(),
                      ...
                      !(w && v < 9) || s || (i && (i.left || i.right)) || ((m = l.parentNode.getClientRects()[0]), (i = m ? { left: m.left, right: m.left + _n(e.display), top: m.top, bottom: m.bottom } : On));
                      for (var h = i.top - t.rect.top, n = i.bottom - t.rect.top, d = (h + n) / 2, f = t.view.measure.heights, p = 0; p < f.length - 1 && !(d < f[p]); p++);
                      var g = p ? f[p - 1] : 0,
                          m = f[p],
                          m = { left: ("right" == u ? i.right : i.left) - t.rect.left, right: ("left" == u ? i.left : i.right) - t.rect.left, top: g, bottom: m };
    ...
    function In(e, t, n, r, i) {
        if ((i || ((i = En(t)), (n.top += i), (n.bottom += i)), "line" == r)) return n;
        r = r || "local";
        t = Vt(t);
        return (
            "local" == r ? (t += vn(e.display)) : (t -= e.display.viewOffset),
            ("page" != r && "window" != r) || ((t += (e = e.display.lineSpace.getBoundingClientRect()).top + ("window" == r ? 0 : Pn())), (r = e.left + ("window" == r ? 0 : Fn())), (n.left += r), (n.right += r)),
            (n.top += t),
            (n.bottom += t),
            n
        );
    ...
    function zn(e, t, n) {
        ...
        var r = t.left,
            t = t.top;
        "page" == n ? ((r -= Fn()), (t -= Pn())) : ("local" != n && n) || ((r += (n = e.display.sizer.getBoundingClientRect()).left), (t += n.top));
    ...
    function Bn(n, e, r, i, o, l) {
        ...
        var a = me(i, n.doc.direction),
            t = e.ch,
            u = e.sticky;
        if ((t >= i.text.length ? ((t = i.text.length), (u = "before")) : t <= 0 && ((t = 0), (u = "after")), !a)) return s("before" == u ? t - 1 : t, "before" == u);
        function c(e, t, n) {
    ...
    function Vn(e, t, n) {
        ...
        var i = et(r, n),
            o = r.first + r.size - 1;
        if (o < i) return Un(r.first + r.size - 1, $e(r, o).text.length, null, 1, 1);
        t < 0 && (t = 0);
        for (var l = $e(r, i); ; ) {
            var s = (function (n, e, t, r, i) {
                        ...
                        ((f = (n.options.lineWrapping
                            ? function (e, t, n, r, i, o, l) {
                                  ...
                                  for (var u = null, c = null, h = 0; h < i.length; h++) {
                                      var d,
                                          f = i[h];
                                      f.from >= a || f.to <= s || ((d = 1 != f.level), (d = Mn(e, r, d ? Math.min(a, f.to) - 1 : Math.max(s, f.from)).right), (d = d < o ? o - d + 1e9 : d - o), (!u || d < c) && ((u = f), (c = d)));
                                  }
                                  u = u || i[i.length - 1];
                            ...
                            : function (n, r, i, o, l, s, a) {
                                  var e = ie(
                                          function (e) {
                                              var t = l[e],
                                                  e = 1 != t.level;
                                              return Xn(Bn(n, rt(i, e ? t.to : t.from, e ? "before" : "after"), "line", r, o), s, a, !0);
                                          },
                                          0,
                                          l.length - 1
                                      ),
                                  ...
                                  {
                                      var u;
                                      0 < e && ((u = 1 != t.level), Xn((u = Bn(n, rt(i, u ? t.from : t.to, u ? "after" : "before"), "line", r, o)), s, a, !0) && u.top > a && (t = l[e - 1]));
                                  }
                                  return t;
                              })(n, e, t, o, c, r, i)),
                        (u = 1 != f.level),
                    ...
                    var h = null,
                        ...
                        c = ie(
                            function (e) {
                                var t = Mn(n, o, e);
                                return (t.top += l), (t.bottom += l), Xn(t, r, i, !1) && (t.top <= i && t.left <= r && ((h = e), (d = t)), 1);
                            },
                            s,
                            a
                        ),
                        f = !1;
                    {
                        var p, g;
                        d
                            ? ((p = r - d.left < d.right - r), (c = h + ((g = p == u) ? 0 : 1)), (g = g ? "after" : "before"), (p = p ? d.left : d.right))
                            : (u || (c != a && c != s) || c++,
                              (g = 0 == c || (c != e.text.length && Mn(n, o, c - (u ? 1 : 0)).bottom + l <= i == u) ? "after" : "before"),
                ...
                a = (function (e, t) {
                    ...
                    if (r)
                        for (var i = 0; i < r.length; ++i) {
                            var o = r[i];
                            o.marker.collapsed && (null == o.from || o.from < t) && (null == o.to || o.to > t) && (!n || Ft(n, o.marker) < 0) && (n = o.marker);
                        }
                    return n;
    ...
    function Yn(e) {
        ...
        if (null == Nn) {
            ...
            for (var t = 0; t < 49; ++t) Nn.appendChild(document.createTextNode("x")), Nn.appendChild(M("br"));
    ...
    function $n(e) {
        ...
        return { fixedPos: qn(t), gutterTotalWidth: t.gutters.offsetWidth, gutterLeft: n, gutterWidth: r, wrapperWidth: t.wrapper.clientWidth };
    }
    function qn(e) {
    ...
    function Jn(e, t, n, r) {
        ...
        var a,
            i = Vn(e, o, l);
        return r && 0 < i.xRel && (a = $e(e.doc, i.line).text).length == i.ch && ((a = E(a, a.length, e.options.tabSize) - a.length), (i = rt(i.line, Math.max(0, Math.round((o - bn(e.display).left) / _n(e.display)) - a)))), i;
    }
    function er(e, t) {
    ...
    function tr(e, t, n, r) {
        ...
        r && n < l.viewTo && (null == l.updateLineNumbers || l.updateLineNumbers > t) && (l.updateLineNumbers = t),
            ...
            t >= l.viewTo
                ...
                : t <= l.viewFrom
                ? (i = ir(e, n, n + r, 1))
                    ? ((l.view = l.view.slice(i.index)), (l.viewFrom = i.lineN), (l.viewTo += r))
                    : rr(e)
                : n >= l.viewTo
                ? (o = ir(e, t, t, -1))
                    ? ((l.view = l.view.slice(0, o.index)), (l.viewTo = o.lineN))
                    : rr(e)
                : ((i = ir(e, t, t, -1)), (o = ir(e, n, n + r, 1)), i && o ? ((l.view = l.view.slice(0, i.index).concat(tn(e, i.lineN, o.lineN)).concat(l.view.slice(o.index))), (l.viewTo += r)) : rr(e));
    ...
    function nr(e, t, n) {
        ...
        i && t >= i.lineN && t < i.lineN + i.size && (r.externalMeasured = null), t < r.viewFrom || t >= r.viewTo || null == (t = r.view[er(e, t)]).node || (-1 == z((t = t.changes || (t.changes = [])), n) && t.push(n));
    }
    function rr(e) {
    ...
    function sr(e, t) {
        ...
        for (var n, r, i = e.doc, o = {}, l = (o.cursors = document.createDocumentFragment()), s = (o.selection = document.createDocumentFragment()), a = 0; a < i.sel.ranges.length; a++)
            (!t && a == i.sel.primIndex) ||
                ...
                (((r = n.empty()) || e.options.showCursorWhenSelecting) && ar(e, n.head, l),
                r ||
                    (function (i, e, t) {
                        var n = i.display,
                            o = i.doc,
                        ...
                        function s(n, g, m) {
                            ...
                            function x(e, t, n) {
                                (e = jn(i, r, null, e)), (t = ("ltr" == t) == ("after" == n) ? "left" : "right");
                            ...
                            return (
                                (function (e, t, n, r) {
                                    ...
                                    var i,
                                        ...
                                        p = !C || r == C.length - 1;
                                    c.top - u.top <= 3
                                        ? ((i = (k ? d : h) && p), (r = (k ? h : d) && f ? S : (a ? u : c).left), (i = i ? L : (a ? c : u).right), T(r, u.top, i - r, u.bottom))
                                        : ((n = a
                                              ? ((o = k && h && f ? S : u.left), (l = k ? L : x(e, n, "before")), (s = k ? S : x(t, n, "after")), k && d && p ? L : c.right)
                                              : ((o = k ? x(e, n, "before") : S), (l = !k && h && f ? L : u.right), (s = !k && d && p ? S : c.left), k ? x(t, n, "after") : L)),
                        ...
                        a.line == n.line
                            ...
                            : ((r = $e(o, a.line)),
                              ...
                              e && (r.top < n.top - 2 ? (T(r.right, r.top, null, r.bottom), T(S, n.top, n.left, n.bottom)) : T(r.right, r.top, n.left - r.right, r.bottom)),
    ...
    function ar(e, t, n) {
        ...
        (t.style.left = r.left + "px"),
            ...
            (t.style.height = Math.max(0, r.bottom - r.top) * e.options.cursorHeight + "px"),
            r.other &&
                (((n = n.appendChild(M("div", " ", "CodeMirror-cursor CodeMirror-secondarycursor"))).style.display = ""),
        ...
        e.state.focused &&
            ...
            0 < e.options.cursorBlinkRate
                ? (t.blinker = setInterval(function () {
                      e.hasFocus() || pr(e), (t.cursorDiv.style.visibility = (n = !n) ? "" : "hidden");
    ...
    function pr(e, t) {
        e.state.delayingBlurEvent ||
            (e.state.focused && (xe(e, "blur", e, t), (e.state.focused = !1), L(e.display.wrapper, "CodeMirror-focused")),
        ...
        for (var t = e.display, n = t.lineDiv.offsetTop, r = 0; r < t.view.length; r++) {
            ...
            if (!o.hidden) {
                w && v < 8
                    ...
                    : ((s = (u = o.node.getBoundingClientRect()).bottom - u.top), !l && o.text.firstChild && (a = o.text.firstChild.getBoundingClientRect().right - u.left - 1));
                var u = o.line.height - s;
                if ((0.005 < u || u < -0.005) && (Qe(o.line, s), mr(o.line), o.rest)) for (var c = 0; c < o.rest.length; c++) mr(o.rest[c]);
                a > e.display.sizerWidth && (a = Math.ceil(a / _n(e.display))) > e.display.maxLineLength && ((e.display.maxLineLength = a), (e.display.maxLine = o.line), (e.display.maxLineChanged = !0));
            }
        }
    }
    function mr(e) {
    ...
    function vr(e, t, n) {
        ...
        return (
            n &&
                n.ensure &&
                ((i = n.ensure.from.line), (n = n.ensure.to.line), i < o ? (r = et(t, Vt($e(t, (o = i))) + e.wrapper.clientHeight)) : Math.min(n, t.lastLine()) >= r && ((o = et(t, Vt($e(t, n)) - e.wrapper.clientHeight)), (r = n))),
    ...
    function Cr(e) {
        ...
        t && ((e.curOp.scrollToPos = null), Sr(e, Gn(e, t.from), Gn(e, t.to), t.margin));
    }
    function Sr(e, t, n, r) {
        r = yr(e, { left: Math.min(t.left, n.left), top: Math.min(t.top, n.top) - r, right: Math.max(t.right, n.right), bottom: Math.max(t.bottom, n.bottom) + r });
        xr(e, r.scrollLeft, r.scrollTop);
    }
    function Lr(e, t) {
        Math.abs(e.doc.scrollTop - t) < 2 || (d || Kr(e, { top: t }), kr(e, t, !0), d && Kr(e), Rr(e, 100));
    }
    function kr(e, t, n) {
    ...
    (e.prototype.update = function (e) {
        ...
        return (
            r
                ? ((this.vert.style.display = "block"), (this.vert.style.bottom = n ? i + "px" : "0"), (t = e.viewHeight - (n ? i : 0)), (this.vert.firstChild.style.height = Math.max(0, e.scrollHeight - e.clientHeight + t) + "px"))
            ...
            n
                ? ((this.horiz.style.display = "block"),
                  ...
                  (this.horiz.firstChild.style.width = Math.max(0, e.scrollWidth - e.clientWidth + t) + "px"))
                : ((this.horiz.style.display = ""), (this.horiz.firstChild.style.width = "0")),
            !this.checkedZeroWidth && 0 < e.clientHeight && (0 == i && this.zeroWidthHack(), (this.checkedZeroWidth = !0)),
    ...
    function Nr(e, t) {
        ...
        Or(e, t);
        for (var i = 0; (i < 4 && n != e.display.barWidth) || r != e.display.barHeight; i++) n != e.display.barWidth && e.options.lineWrapping && gr(e), Or(e, Mr(e)), (n = e.display.barWidth), (r = e.display.barHeight);
    }
    function Or(e, t) {
        var n = e.display,
    ...
    function Dr(n) {
        n.display.scrollbars && (n.display.scrollbars.clear(), n.display.scrollbars.addClass && L(n.display.wrapper, n.display.scrollbars.addClass)),
            ...
            n.display.scrollbars.addClass && D(n.display.wrapper, n.display.scrollbars.addClass);
    }
    var Wr = 0;
    function Hr(e) {
        (e.curOp = {
                    ...
                    for (var t = e.ops, n = 0; n < t.length; n++)
                        !(function (e) {
                            ...
                            (e.mustUpdate =
                                ...
                                (e.update = e.mustUpdate && new Gr(t, e.mustUpdate && { top: e.scrollTop, ensure: e.scrollToPos }, e.forceUpdate));
                        })(t[n]);
                        ...
                        !(function (e) {
                            ...
                            (e.barMeasure = Mr(t)),
                                n.maxLineChanged &&
                                    ...
                                    ((e.adjustWidthTo = Ln(t, n.maxLine, n.maxLine.text.length).left + 3),
                                    (t.display.sizerWidth = e.adjustWidthTo),
                                    (e.barMeasure.scrollWidth = Math.max(n.scroller.clientWidth, n.sizer.offsetLeft + e.adjustWidthTo + wn(t) + t.display.barWidth)),
                    ...
                    for (var o = 0; o < t.length; o++)
                        !(function (e) {
                            ...
                            null != e.adjustWidthTo &&
                                ((t.display.sizer.style.minWidth = e.adjustWidthTo + "px"), e.maxScrollLeft < t.doc.scrollLeft && Tr(t, Math.min(t.display.scroller.scrollLeft, e.maxScrollLeft), !0), (t.display.maxLineChanged = !1));
                                    ...
                                    ((i = (function (e, t, n, r) {
                                        ...
                                        for (var i = 0; i < 5; i++) {
                                            var o,
                                                ...
                                                s = Bn(e, t),
                                                a = n && n != t ? Bn(e, n) : s,
                                                u = yr(e, (o = { left: Math.min(s.left, a.left), top: Math.min(s.top, a.top) - r, right: Math.max(s.left, a.left), bottom: Math.max(s.bottom, a.bottom) + r })),
                                                s = e.doc.scrollTop,
                                                a = e.doc.scrollLeft;
        ...
        c.highlightFrontier >= l.display.viewTo ||
            ...
            c.iter(a.line, Math.min(c.first + c.size, l.display.viewTo + 500), function (e) {
                if (a.line >= l.display.viewFrom) {
                    var t = e.styles,
                        n = e.text.length > l.options.maxHighlightLength ? je(c.mode, a.state) : null,
                        r = pt(l, e, a, !0);
                ...
                } else e.text.length <= l.options.maxHighlightLength && vt(l, e.text, a), (e.stateAfter = a.line % 5 == 0 ? a.save() : null), a.nextLine();
                if (+new Date() > s) return Rr(l, l.options.workDelay), !0;
            }),
    ...
    function Ur(e, t) {
        ...
        n.viewFrom < o && o - n.viewFrom < 20 && (o = Math.max(r.first, n.viewFrom)), n.viewTo > l && n.viewTo - l < 20 && (l = Math.min(i, n.viewTo)), kt && ((o = Bt(e.doc, o)), (l = Gt(e.doc, l)));
        ...
        (r = o),
            ...
            0 == (l = (o = e).display).view.length || r >= l.viewTo || i <= l.viewFrom
                ...
                : (l.viewFrom > r ? (l.view = tn(o, r, l.viewFrom).concat(l.view)) : l.viewFrom < r && (l.view = l.view.slice(er(o, r))),
                  (l.viewFrom = r),
                  l.viewTo < i ? (l.view = l.view.concat(tn(o, l.viewTo, i))) : l.viewTo > i && (l.view = l.view.slice(0, er(o, i)))),
            (l.viewTo = i),
            ...
            return (
                !window.getSelection ||
                    ((t = window.getSelection()).anchorNode &&
                        ...
                        ((n.anchorNode = t.anchorNode), (n.anchorOffset = t.anchorOffset), (n.focusNode = t.focusNode), (n.focusOffset = t.focusOffset))),
                n
            );
        })(e);
        return (
                ...
                for (var a = r.view, u = r.viewFrom, c = 0; c < a.length; c++) {
                    ...
                    if (!h.hidden)
                        if (h.node && h.node.parentNode == o) {
                            ...
                            h.changes && (-1 < z(h.changes, "gutter") && (d = !1), an(n, h, u, t)), d && (k(h.lineNumber), h.lineNumber.appendChild(document.createTextNode(nt(n.options, u)))), (l = h.node.nextSibling);
                        } else {
                            d = (function (e, t, n, r) {
                                var i = cn(e, t);
                                return (t.text = t.node = i.pre), i.bgClass && (t.bgClass = i.bgClass), i.textClass && (t.textClass = i.textClass), hn(e, t), dn(e, t, n, r), fn(e, t, r), t.node;
                            })(n, h, u, t);
                            o.insertBefore(d, l);
                        }
                    u += h.size;
            ...
            (i = l) &&
                ...
                !/^(INPUT|TEXTAREA)$/.test(i.activeElt.nodeName) &&
                    ...
                    ((o = window.getSelection()), (l = document.createRange()).setEnd(i.anchorNode, i.anchorOffset), l.collapse(!1), o.removeAllRanges(), o.addRange(l), o.extend(i.focusNode, i.focusOffset))),
            k(n.cursorDiv),
            k(n.selectionDiv),
            (n.gutters.style.height = n.sizer.style.minHeight = 0),
            s && ((n.lastWrapHeight = t.wrapperHeight), (n.lastWrapWidth = t.wrapperWidth), Rr(e, 400)),
            !(n.updateLineNumbers = null)
        );
    }
    function Vr(e, t) {
        for (var n = t.viewport, r = !0; ; r = !1) {
            if (r && e.options.lineWrapping && t.oldDisplayWidth != xn(e)) r && (t.visible = vr(e.display, e.doc, n));
            else if ((n && null != n.top && (n = { top: Math.min(e.doc.height + yn(e.display) - Cn(e), n.top) }), (t.visible = vr(e.display, e.doc, n)), t.visible.from >= e.display.viewFrom && t.visible.to <= e.display.viewTo)) break;
            if (!Ur(e, t)) break;
            gr(e);
            var i = Mr(e);
    ...
    function Qr(e, t, n, r) {
        ...
        (i.mover = M("div", [o], null, "position: relative")),
            ...
            (i.sizerWidth = null),
            (i.heightForcer = M("div", null, null, "position: absolute; height: " + R + "px; width: 1px;")),
    ...
    function ri(e, t) {
        ...
        if ((r && s) || (i && a)) {
            ...
            if (r && !d && !p && null != ei) return i && a && Lr(e, Math.max(0, l.scrollTop + i * ei)), Tr(e, Math.max(0, l.scrollLeft + r * ei)), (!i || (i && a)) && Te(t), void (o.wheelStartX = null);
            i && null != ei && ((n = i * ei), (a = (s = e.doc.scrollTop) + o.wrapper.clientHeight), n < 0 ? (s = Math.max(0, s + n - 50)) : (a = Math.min(e.doc.height, a + n + 50)), Kr(e, { top: s, bottom: a })),
                Jr < 20 &&
                    (null == o.wheelStartX
                        ? ((o.wheelStartX = l.scrollLeft),
                          ...
                          setTimeout(function () {
                              ...
                              null != o.wheelStartX &&
                                  ...
                                  (t = ((e = l.scrollTop - o.wheelStartY) && o.wheelDY && e / o.wheelDY) || (t && o.wheelDX && t / o.wheelDX)),
    ...
    function li(e, t, n) {
        ...
        for (var i = 1; i < t.length; i++) {
            var o,
                ...
                s = t[i - 1],
                a = it(s.to(), l.from());
            (r && !l.empty() ? 0 < a : 0 <= a) && ((o = at(s.from(), l.from())), (a = st(s.to(), l.to())), (s = s.empty() ? l.from() == l.head : s.from() == s.head), i <= n && --n, t.splice(--i, 2, new oi(s ? a : o, s ? o : a)));
        }
        return new ii(t, n);
    }
    function si(e, t) {
    ...
    function ai(e) {
        return e.text ? rt(e.from.line + e.text.length - 1, Y(e.text).length + (1 == e.text.length ? e.from.ch : 0)) : e.to;
    }
    function ui(e, t) {
    ...
    function gi(e, o, t, l) {
        ...
        o.full
            ...
            : pi(e, o)
            ? ((s = r(0, c.length - 1)), n(d, d.text, p), g && e.remove(a.line, g), s.length && e.insert(a.line, s))
            : h == d
            ? 1 == c.length
                ? n(h, h.text.slice(0, a.ch) + f + h.text.slice(u.ch), p)
                : ((s = r(1, c.length - 1)).push(new Xt(f + h.text.slice(u.ch), p, l)), n(h, h.text.slice(0, a.ch) + c[0], i(0)), e.insert(a.line + 1, s))
            : 1 == c.length
            ? (n(h, h.text.slice(0, a.ch) + c[0] + d.text.slice(u.ch), i(0)), e.remove(a.line + 1, g))
            : (n(h, h.text.slice(0, a.ch) + c[0], i(0)), n(d, f + d.text.slice(u.ch), p), (p = r(1, c.length - 1)), 1 < g && e.remove(a.line + 1, g - 1), e.insert(a.line + 1, p)),
            ln(e, "change", e, o);
    }
    function mi(e, s, a) {
        !(function e(t, n, r) {
    ...
    function vi(e, t) {
        ...
        Qn(((e.doc = t).cm = e)), di(e), yi(e), e.options.lineWrapping || jt(e), (e.options.mode = t.modeOption), tr(e);
    }
    function yi(e) {
    ...
    function Ci(e, t, n, r) {
        ...
        if (
            ...
            (o = (a = i).lastOp == r ? (xi(a.done), Y(a.done)) : a.done.length && !Y(a.done).ranges ? Y(a.done) : 1 < a.done.length && !a.done[a.done.length - 2].ranges ? (a.done.pop(), Y(a.done)) : void 0)
        )
            (l = Y(o.changes)), 0 == it(t.from, t.to) && 0 == it(t.from, l.to) ? (l.to = ai(t)) : o.changes.push(wi(e, t));
        else {
            var a = Y(i.done);
            for ((a && a.ranges) || Li(e.sel, i.done), o = { changes: [wi(e, t)], generation: i.generation }, i.done.push(o); i.done.length > i.undoDepth; ) i.done.shift(), i.done[0].ranges || i.done.shift();
        }
        i.done.push(n), (i.generation = ++i.maxGeneration), (i.lastModTime = i.lastSelTime = s), (i.lastOp = i.lastSelOp = r), (i.lastOrigin = i.lastSelOrigin = t.origin), l || xe(e, "historyAdded");
    }
    function Si(e, t, n, r) {
        var i,
            o,
        ...
        (a &&
            ...
            ((s.lastModTime == s.lastSelTime && s.lastOrigin == a) ||
                ...
                (l = Y(s.done)),
                (e = t),
                "*" == (o = o.charAt(0)) || ("+" == o && l.ranges.length == e.ranges.length && l.somethingSelected() == e.somethingSelected() && new Date() - i.history.lastSelTime <= (i.cm ? i.cm.options.historyEventDelay : 500)))))
        ...
        for (var r = [], i = 0; i < e.length; ++i) {
            ...
            if (o.ranges) r.push(n ? ii.prototype.deepCopy.call(o) : o);
                ...
                for (var a = 0; a < l.length; ++a) {
                    var u,
                        c = l[a];
                    if ((s.push({ from: c.from, to: c.to, text: c.text }), t)) for (var h in c) (u = h.match(/^spans_(\d+)$/)) && -1 < z(t, Number(u[1])) && ((Y(s)[h] = c[h]), delete c[h]);
                }
            }
        }
        return r;
    ...
    function Oi(e, t, n, r) {
        if (r) {
            r = e.anchor;
            return n && ((e = it(t, r) < 0) != it(n, r) < 0 ? ((r = t), (t = n)) : e != it(t, n) < 0 && (t = n)), new oi(r, t);
        }
        return new oi(n || t, t);
    }
    function Ai(e, t, n, r, i) {
        null == i && (i = e.cm && (e.cm.display.shift || e.extend)), Pi(e, new ii([Oi(e.sel.primary(), t, n, i)], 0), r);
    }
    function Di(e, t, n) {
    ...
    function Ei(e, t, n) {
        ...
        Ii(e, Ri(e, t, o, !0)), (n && !1 === n.scroll) || !e.cm || "nocursor" == e.cm.getOption("readOnly") || wr(e.cm);
    }
    function Ii(e, t) {
        t.equals(e.sel) || ((e.sel = t), e.cm && ((e.cm.curOp.updateInput = 1), (e.cm.curOp.selectionChanged = !0), Se(e.cm)), ln(e, "cursorActivity", e));
    }
    function zi(e) {
                    ...
                    if (a.atomic) {
                        if (n) {
                            var h = a.find(r < 0 ? 1 : -1),
                                s = void 0;
                            if (((r < 0 ? c : u) && (h = Ui(e, h, -r, h && h.line == t.line ? o : null)), h && h.line == t.line && (s = it(h, n)) && (r < 0 ? s < 0 : 0 < s))) return Bi(e, h, t, r, i);
                        }
                        a = a.find(r < 0 ? -1 : 1);
                        return (r < 0 ? u : c) && (a = Ui(e, a, r, a.line == t.line ? o : null)), a ? Bi(e, a, t, r, i) : null;
                    }
                }
            }
        return t;
    ...
    function Ui(e, t, n, r) {
        return n < 0 && 0 == t.ch ? (t.line > e.first ? ct(e, rt(t.line - 1)) : null) : 0 < n && t.ch == (r || $e(e, t.line)).text.length ? (t.line < e.first + e.size - 1 ? rt(t.line + 1, 0) : null) : new rt(t.line, t.ch + n);
    }
    function Vi(e) {
    ...
    function ji(e, t, n) {
        ...
        if (!(Le(e, "beforeChange") || (e.cm && Le(e.cm, "beforeChange"))) || (t = Ki(e, t, !0))) {
            var r =
                Lt &&
                !n &&
                (function (e, t, n) {
            ...
            if (r) for (var i = r.length - 1; 0 <= i; --i) Xi(e, { from: r[i].from, to: r[i].to, text: i ? [""] : t.text, origin: t.origin });
            else Xi(e, t);
        }
    }
    function Xi(e, n) {
        ...
        (1 == n.text.length && "" == n.text[0] && 0 == it(n.from, n.to)) ||
            ...
            (r = []),
            mi(e, function (e, t) {
                t || -1 != z(r, e.history) || (Ji(e.history, n), r.push(e.history)), $i(e, n, null, Nt(e, n));
            }));
    }
    function Yi(i, o, e) {
        ...
        if (!t || e) {
            ...
            if (u != s.length) {
                for (n.lastOrigin = n.lastSelOrigin = null; ; ) {
                    ...
                    if ((Li(l, a), e && !l.equals(i.sel))) return void Pi(i, l, { clearRedo: !1 });
                    r = l;
                }
                var c = [];
                Li(r, a), a.push({ changes: c, generation: n.generation }), (n.generation = l.generation || ++n.maxGeneration);
                for (var h = Le(i, "beforeChange") || (i.cm && Le(i.cm, "beforeChange")), d = l.changes.length - 1; 0 <= d; --d) {
                    var f = (function (e) {
                        var n = l.changes[e];
                        if (((n.origin = o), h && !Ki(i, n, !1))) return (s.length = 0), {};
                        c.push(wi(i, n));
                        var t = e ? ci(i, n) : Y(s);
                        $i(i, n, t, Mi(i, n)), !e && i.cm && i.cm.scrollIntoView({ from: n.from, to: ai(n) });
                        var r = [];
                        mi(i, function (e, t) {
                            t || -1 != z(r, e.history) || (Ji(e.history, n), r.push(e.history)), $i(e, n, null, Mi(e, n));
                        });
                    })(d);
                    if (f) return f.v;
                }
    ...
    function $i(e, t, n, r) {
        ...
        t.to.line < e.first
            ...
            : t.from.line > e.lastLine() ||
              (t.from.line < e.first && (_i(e, (i = t.text.length - 1 - (e.first - t.from.line))), (t = { from: rt(e.first, 0), to: rt(t.to.line + i, t.to.ch), text: [Y(t.text)], origin: t.origin })),
              (i = e.lastLine()),
              t.to.line > i && (t = { from: t.from, to: rt(i, $e(e, i).text.length), text: [t.text[0]], origin: t.origin }),
              ...
              e.cm
                  ? (function (e, t, n) {
                        ...
                        (a || r) && ((t = { from: o, to: l, text: t.text, removed: t.removed, origin: t.origin }), a && ln(e, "change", e, t), r && (e.curOp.changeObjs || (e.curOp.changeObjs = [])).push(t));
    ...
    function qi(e, t, n, r, i) {
        var o;
        it((r = r || n), n) < 0 && ((n = (o = [r, n])[0]), (r = o[1])), "string" == typeof t && (t = e.splitLines(t)), ji(e, { from: n, to: r, text: t, origin: i });
    }
    function Zi(e, t, n, r) {
        ...
        for (var i = 0; i < e.length; ++i) {
            ...
            if (o.ranges) {
                ...
                for (var a = 0; a < o.changes.length; ++a) {
                    var u = o.changes[a];
                    if (n < u.from.line) (u.from = rt(u.from.line + r, u.from.ch)), (u.to = rt(u.to.line + r, u.to.ch));
                    else if (t <= u.to.line) {
                        l = !1;
                        break;
                    }
    ...
    function eo(e, t, n, r) {
        var i = t,
            o = t;
        return "number" == typeof t ? (o = $e(e, ut(e, t))) : (i = Je(t)), null == i ? null : (r(o, i) && e.cm && nr(e.cm, i, n), o);
    }
    function to(e) {
            ...
            maybeSpill: function () {
                if (!(this.children.length <= 10)) {
                    ...
                    do {
                        ...
                        (e.parent ? ((e.size -= n.size), (e.height -= n.height), (t = z(e.parent.children, e)), e.parent.children.splice(t + 1, 0, n)) : ((((t = new no(e.children)).parent = e).children = [t, n]), (e = t)),
                        (n.parent = e.parent),
    ...
    function so(t, n, r, e, i) {
        ...
        var o = new lo(t, i),
            i = it(n, r);
        if ((e && P(e, o, !1), 0 < i || (0 == i && !1 !== o.clearWhenEmpty))) return o;
        if (
            (o.replacedWith &&
                ((o.collapsed = !0), (o.widgetNode = N("span", [o.replacedWith], "CodeMirror-widget")), e.handleMouseEvents || o.widgetNode.setAttribute("cm-ignore-events", "true"), e.insertLeft && (o.widgetNode.insertLeft = !0)),
            o.collapsed)
        ) {
            if (zt(t, n.line, n, r, o) || (n.line != r.line && zt(t, r.line, n, r, o))) throw new Error("Inserting collapsed marker partially overlapping an existing one");
            kt = !0;
        }
        ...
        if (
            (t.iter(s, r.line + 1, function (e) {
                var t;
                a && o.collapsed && !a.options.lineWrapping && Rt(e) == a.display.maxLine && (l = !0),
            ...
            o.readOnly && ((Lt = !0), (t.history.done.length || t.history.undone.length) && t.clearHistory()),
            o.collapsed && ((o.id = ++oo), (o.atomic = !0)),
            a)
        ) {
            if ((l && (a.curOp.updateMaxLine = !0), o.collapsed)) tr(a, n.line, r.line + 1);
            else if (o.className || o.startStyle || o.endStyle || o.css || o.attributes || o.title) for (var u = n.line; u <= r.line; u++) nr(a, u, "text");
            o.atomic && zi(a.doc), ln(a, "markerAdded", a, o);
        }
        return o;
    }
    (lo.prototype.clear = function () {
        if (!this.explicitlyCleared) {
            var e,
                t = this.doc.cm,
                n = t && !t.curOp;
            n && Hr(t), !Le(this, "clear") || ((e = this.find()) && ln(this, "clear", e.from, e.to));
            for (var r = null, i = null, o = 0; o < this.lines.length; ++o) {
                var l = this.lines[o],
                    s = Mt(l.markedSpans, this);
                t && !this.collapsed ? nr(t, Je(l), "text") : t && (null != s.to && (i = Je(l)), null != s.from && (r = Je(l))),
                    (l.markedSpans = (function (e, t) {
                        for (var n, r = 0; r < e.length; ++r) e[r] != t && (n = n || []).push(e[r]);
                        return n;
                    })(l.markedSpans, s)),
                    null == s.from && this.collapsed && !Ut(this.doc, l) && t && Qe(l, Yn(t.display));
            }
            ...
            null != r && t && this.collapsed && tr(t, r, i + 1),
                ...
                this.atomic && this.doc.cantEdit && ((this.doc.cantEdit = !1), t && zi(t.doc)),
            ...
            r &&
                ...
                Pr(o, function () {
                    ...
                    t && (Dn(t), (o.curOp.selectionChanged = o.curOp.forceUpdate = !0)),
                        ...
                        Ut(i.doc, e) || null == i.height || ((t = i.height), (i.height = null), (t = gn(i) - t) && Qe(e, e.height + t)),
                        ln(o, "markerChanged", o, n);
                });
        }),
        (lo.prototype.attachLine = function (e) {
            var t;
            !this.lines.length && this.doc.cm && (((t = this.doc.cm.curOp).maybeHiddenMarkers && -1 != z(t.maybeHiddenMarkers, this)) || (t.maybeUnhiddenMarkers || (t.maybeUnhiddenMarkers = [])).push(this)), this.lines.push(e);
        }),
        (lo.prototype.detachLine = function (e) {
            this.lines.splice(z(this.lines, e), 1), !this.lines.length && this.doc.cm && ((e = this.doc.cm.curOp).maybeHiddenMarkers || (e.maybeHiddenMarkers = [])).push(this);
        }),
        ke(lo);
    var ao = function (e, t) {
    ...
    var co = 0,
        ho = function (e, t, n, r, i) {
            ...
            null == n && (n = 0), no.call(this, [new to([new Xt("", null)])]), (this.first = n), (this.scrollTop = this.scrollLeft = 0), (this.cantEdit = !1), (this.cleanGeneration = 1);
    ...
    (ho.prototype = q(no.prototype, {
        ...
        setValue: zr(function (e) {
            ...
            ji(this, { from: t, to: rt(n, $e(this, n).text.length), text: this.splitLines(e), origin: "setValue", full: !0 }, !0), this.cm && xr(this.cm, 0, 0), Pi(this, si(t), G);
        }),
        ...
        getLineHandleVisualStart: function (e) {
            return "number" == typeof e && (e = $e(this, e)), Rt(e);
        },
        lineCount: function () {
            return this.size;
        },
        ...
        setSelections: zr(function (e, t, n) {
            if (e.length) {
                for (var r = [], i = 0; i < e.length; i++) r[i] = new oi(ct(this, e[i].anchor), ct(this, e[i].head || e[i].anchor));
                null == t && (t = Math.min(e.length - 1, this.sel.primIndex)), Pi(this, li(this.cm, r, t), n);
            }
        }),
        addSelection: zr(function (e, t, n) {
            var r = this.sel.ranges.slice(0);
            r.push(new oi(ct(this, e), ct(this, t || e))), Pi(this, li(this.cm, r, r.length - 1), n);
        }),
        getSelection: function (e) {
            for (var t = this.sel.ranges, n = 0; n < t.length; n++) var r = qe(this, t[n].from(), t[n].to()), i = i ? i.concat(r) : r;
        ...
        addLineWidget: zr(function (e, t, n) {
            return (
                ...
                eo(r, e, "widget", function (e) {
                    ...
                    return (
                        null == i.insertAt ? t.push(i) : t.splice(Math.min(t.length, Math.max(0, i.insertAt)), 0, i),
                        (i.line = e),
                        o && !Ut(r, e) && ((t = Vt(e) < r.scrollTop), Qe(e, e.height + gn(i)), t && br(o, i.height), (o.curOp.forceUpdate = !0)),
                        1
                    );
                }),
        ...
        setBookmark: function (e, t) {
            t = { replacedWith: t && (null == t.nodeType ? t.widget : t), insertLeft: t && t.insertLeft, clearWhenEmpty: !1, shared: t && t.shared, handleMouseEvents: t && t.handleMouseEvents };
        ...
        linkedDoc: function (e) {
            ...
            return (
                ...
                (this.linked || (this.linked = [])).push({ doc: t, sharedHist: e.sharedHist }),
                                ...
                                for (var e = 0; e < o.length; e++)
                                    !(function (e) {
                                        ...
                                        for (var r = 0; r < t.markers.length; r++) {
                                            var i = t.markers[r];
                                            -1 == z(n, i.doc) && ((i.parent = null), t.markers.splice(r--, 1));
                                        }
                                    })(e);
                            })(uo(this));
                        break;
            ...
            if (t && !r.isReadOnly())
                if (n && n.length && window.FileReader && window.File)
                    for (
                        ...
                        !(function (e, t) {
                            var n;
                            r.options.allowDropFileTypes && -1 == z(r.options.allowDropFileTypes, e.type)
                                ? s()
                    ...
                    try {
                        ...
                        if (c) {
                            if ((r.state.draggingText && !r.state.draggingText.copy && (u = r.listSelections()), Ei(r.doc, si(t, t)), u)) for (var h = 0; h < u.length; ++h) qi(r.doc, "", u[h].anchor, u[h].head, "drag");
    ...
    function Mo(e, t, n, r) {
        ...
        if (t.fallthrough) {
            if ("[object Array]" != Object.prototype.toString.call(t.fallthrough)) return Mo(e, t.fallthrough, n, r);
    ...
    function Ao(e, t) {
        ...
        var n = wo[e.keyCode];
        return null != n && !e.altGraphKey && (3 == e.keyCode && e.code && (n = e.code), Oo(n, e, t));
    }
    function Do(e) {
    ...
    function Wo(t, e) {
        ...
        Pr(t, function () {
            for (var e = r.length - 1; 0 <= e; e--) qi(t.doc, "", r[e].from, r[e].to, "+delete");
            wr(t);
        });
    }
    function Ho(e, t, n) {
    ...
    function Eo(t, n, s, e) {
        ...
        var r = le(a, s.ch, s.sticky),
            i = a[r];
        if ("ltr" == t.doc.direction && i.level % 2 == 0 && (0 < e ? i.to > s.ch : i.from < s.ch)) return Fo(n, s, e);
        function u(e, t) {
            return Ho(n, e instanceof rt ? e.ch : e, t);
        }
        function o(e) {
            return t.options.lineWrapping ? ((l = l || Tn(t, n)), jn(t, n, l, e)) : { begin: 0, end: n.text.length };
        }
        var l,
        ...
        return null == c || (0 < e && c == n.text.length) || !(r = f(0 < e ? 0 : a.length - 1, e, o(c))) ? null : r;
    }
    (Lo.basic = {
        Left: "goCharLeft",
        Right: "goCharRight",
    ...
    var Io = {
        ...
        killLine: function (n) {
            return Wo(n, function (e) {
                if (e.empty()) {
                    ...
                    return e.head.ch == t && e.head.line < n.lastLine() ? { from: e.head, to: rt(e.head.line + 1, 0) } : { from: e.head, to: rt(e.head.line, t) };
                }
        ...
        deleteLine: function (t) {
            return Wo(t, function (e) {
                return { from: rt(e.from().line, 0), to: ct(t.doc, rt(e.to().line + 1, 0)) };
            });
        },
        ...
        goLineLeftSmart: function (n) {
            return n.extendSelectionsBy(function (e) {
                ...
                return t.ch < n.getLine(t.line).search(/\S/) ? Ro(n, e.head) : t;
            }, V);
        },
        goLineUp: function (e) {
                ...
                for (var e, t, n, r = l.listSelections(), i = [], o = 0; o < r.length; o++)
                    r[o].empty() &&
                        ...
                        (t = $e(l.doc, e.line).text) &&
                            ...
                            0 < e.ch
                                ? ((e = new rt(e.line, e.ch + 1)), l.replaceRange(t.charAt(e.ch - 1) + t.charAt(e.ch - 2), rt(e.line, e.ch - 2), e, "+transpose"))
                                : e.line > l.doc.first &&
                                  (n = $e(l.doc, e.line - 1).text) &&
                                  ((e = new rt(e.line, 1)), l.replaceRange(t.charAt(0) + l.doc.lineSeparator() + n.charAt(n.length - 1), rt(e.line - 1, n.length - 1), e, "+transpose"))),
                        i.push(new oi(e, e)));
                l.setSelections(i);
            });
        },
    ...
    function Vo(e, t, n, r) {
        r = (function (e, t, n) {
            ...
            return (e.options.extraKeys && Mo(t, e.options.extraKeys, n, e)) || Mo(t, e.options.keyMap, n, e);
        })(e, t, r);
        return "multi" == r && (e.state.keySeq = t), "handled" == r && ln(e, "keyHandled", e, t, n), ("handled" != r && "multi" != r) || (Te(n), cr(e)), !!r;
    }
    function Ko(t, e) {
        var n = Ao(e, !0);
        return (
    ...
    function Xo(e) {
        var t,
            ...
            i = this;
        function o(e) {
            (18 != e.keyCode && e.altKey) || (L(r, "CodeMirror-crosshair"), we(document, "keyup", o), we(document, "mouseover", o));
        }
        (e.target && e.target != i.display.input.getField()) ||
            ...
            Ce(i, e) ||
                ...
                (n = Ko(i, e)),
                p && ((jo = n ? t : null), !n && 88 == t && !Ie && (g ? e.metaKey : e.ctrlKey) && i.replaceSelection("", null, "cut")),
                d && !g && !n && 46 == t && e.shiftKey && !e.ctrlKey && document.execCommand && document.execCommand("cut"),
                18 != t || /\bCodeMirror-crosshair\b/.test(i.display.lineDiv.className) || (D((r = i.display.lineDiv), "CodeMirror-crosshair"), ye(document, "keyup", o), ye(document, "mouseover", o))));
    }
    function Yo(e) {
    ...
    function _o(e) {
        var t = this;
        if (!((e.target && e.target != t.display.input.getField()) || mn(t.display, e) || Ce(t, e) || (e.ctrlKey && !e.altKey) || (g && e.metaKey))) {
            var n,
                r = e.keyCode,
                i = e.charCode;
                ...
                : tl(l, e) ||
                  ...
                  (i = t
                      ? ((r = t),
                        (i = n),
                        (o = +new Date()),
                        qo && qo.compare(o, r, i) ? (($o = qo = null), "triple") : $o && $o.compare(o, r, i) ? ((qo = new Zo(o, r, i)), ($o = null), "double") : (($o = new Zo(o, r, i)), (qo = null), "single"))
                      : "single"),
                  window.focus(),
                  ...
                  (t &&
                      (function (n, e, r, t, i) {
                          ...
                          return Uo(n, Oo((o = (1 == e ? "Left" : 2 == e ? "Middle" : "Right") + o), i), i, function (e) {
                          ...
                          ? t
                              ? (function (e, t, n, r) {
                                    ...
                                    var i,
                                        ...
                                        l = e.doc.sel;
                                    (e.options.dragDrop && Fe && !e.isReadOnly() && "single" == n && -1 < (i = l.contains(t)) && (it((i = l.ranges[i]).from(), t) < 0 || 0 < t.xRel) && (0 < it(i.to(), t) || t.xRel < 0)
                                        ? function (t, n, r, i) {
                                              var o = t.display,
                                                  l = !1,
                                                  s = Er(t, function (e) {
                                        ...
                                        : function (d, e, f, p) {
                                              ...
                                              "rectangle" == p.unit ? (p.addNew || (m = new oi(f, f)), (f = Jn(d, e, !0, !0)), (v = -1)) : ((e = Jo(d, f, p.unit)), (m = p.extend ? Oi(m, e.anchor, e.head, p.extend) : e));
                                              p.addNew
                                                  ? -1 == v
                                                      ? ((v = t.length), Pi(g, li(d, t.concat([m]), v), { scroll: !1, origin: "*mouse" }))
                                                      : 1 < t.length && t[v].empty() && "char" == p.unit && !p.extend
                                                      ? (Pi(g, li(d, t.slice(0, v).concat(t.slice(v + 1)), 0), { scroll: !1, origin: "*mouse" }), (y = g.sel))
                                                      : Wi(g, v, m, U)
                                                  ...
                                                  if (0 != it(b, e))
                                                      if (((b = e), "rectangle" == p.unit)) {
                                                          for (
                                                              ...
                                                              var u = $e(g, s).text,
                                                                  c = K(u, o, n);
                                                              o == l ? t.push(new oi(rt(s, c), rt(s, c))) : u.length > c && t.push(new oi(rt(s, c), rt(s, K(u, l, n))));
                                                          }
                                                          t.length || t.push(new oi(f, f)), Pi(g, li(d, y.ranges.slice(0, v).concat(t), v), { origin: "*mouse", scroll: !1 }), d.scrollIntoView(e);
                                                      } else {
                                                          var h,
                                                              r = m,
                                                              i = Jo(d, e, p.unit),
                                                              e = r.anchor,
                                                              e = 0 < it(i.anchor, e) ? ((h = i.head), at(r.from(), i.anchor)) : ((h = i.anchor), st(r.to(), i.head)),
                                                              i = y.ranges.slice(0);
                                                          (i[v] = (function (e, t) {
                                                              var n = t.anchor,
                                                                  r = t.head,
                                                              ...
                                                              a =
                                                                  r.line != n.line
                                                                      ...
                                                                      : ((e = le(o, r.ch, r.sticky)), (a = e - l || (r.ch - n.ch) * (1 == s.level ? -1 : 1)), e == i - 1 || e == i ? a < 0 : 0 < a);
                                                              var i = o[i + (a ? -1 : 0)],
                                                                  a = a == (1 == i.level),
                                                                  i = a ? i.from : i.to,
                                                                  a = a ? "after" : "before";
                                              ...
                                              var r = Er(d, function (e) {
                                                  ...
                                                  i = Er(d, n);
                                              (d.state.selectingText = i), ye(l.wrapper.ownerDocument, "mousemove", r), ye(l.wrapper.ownerDocument, "mouseup", i);
                                          })(e, r, t, o);
                                })(l, t, i, e)
    ...
    function el(e, t, n, r) {
        ...
        for (var s = 0; s < e.display.gutterSpecs.length; ++s) {
            ...
            if (a && a.getBoundingClientRect().right >= i) return xe(e, n, e, et(e.doc, o), e.display.gutterSpecs[s].className, t), Ne(t);
        }
    }
    function tl(e, t) {
    ...
    function nl(e, t) {
        var n, r;
        mn(e.display, t) || ((r = t), Le((n = e), "gutterContextMenu") && el(n, r, "gutterContextMenu", !1)) || Ce(e, t, "contextmenu") || x || e.display.input.onContextMenu(t);
    }
    function rl(e) {
    ...
    function al(e) {
        e.options.lineWrapping ? (D(e.display.wrapper, "CodeMirror-wrap"), (e.display.sizer.style.minWidth = ""), (e.display.sizerWidth = null)) : (L(e.display.wrapper, "CodeMirror-wrap"), jt(e)),
            Qn(e),
            tr(e),
            Hn(e),
            setTimeout(function () {
    ...
    function ul(e, t) {
        ...
        var r = t.value;
        "string" == typeof r ? (r = new ho(r, t.mode, null, t.lineSeparator, t.direction)) : t.mode && (r.modeOption = t.mode), (this.doc = r);
        var i,
        ...
        (function (r) {
            ...
            ye(i.scroller, "mousedown", Er(r, Qo)),
                ye(
                    ...
                    w && v < 11
                        ? Er(r, function (e) {
                              var t;
                              Ce(r, e) || !(t = Jn(r, e)) || tl(r, e) || mn(r.display, e) || (Te(e), (t = r.findWordAt(t)), Ai(r.doc, t.anchor, t.head));
                          })
                        : function (e) {
                              return Ce(r, e) || Te(e);
                          }
            ...
            ye(i.scroller, "touchstart", function (e) {
                ...
                Ce(r, e) ||
                    ...
                    clearTimeout(n),
                    (t = +new Date()),
                    (i.activeTouch = { start: t, moved: !1, prev: t - o.end <= 300 ? o : null }),
                ...
                ye(i.scroller, "scroll", function () {
                    i.scroller.clientHeight && (Lr(r, i.scroller.scrollTop), Tr(r, i.scroller.scrollLeft, !0), xe(r, "scroll", r));
                }),
                    ...
                    over: function (e) {
                        ...
                        Ce(r, e) ||
                            ((n = Jn((t = r), (n = e))) &&
                                ...
                                t.display.dragCursor || ((t.display.dragCursor = M("div", null, "CodeMirror-cursors CodeMirror-dragcursors")), t.display.lineSpace.insertBefore(t.display.dragCursor, t.display.cursorDiv)),
                            ...
                            void (w && (!t.state.draggingText || +new Date() - fo < 100)
                                ...
                                : Ce(t, n) ||
                                  ...
                                  n.dataTransfer.setDragImage &&
                                      !c &&
                                      (((e = M("img", null, null, "position: fixed; left: 0; top: 0;")).src = "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="),
        ...
        Fr(this), f && t.lineWrapping && "optimizelegibility" == getComputedStyle(o.lineDiv).textRendering && (o.lineDiv.style.textRendering = "auto");
    }
    ...
    function hl(e, t, n, r) {
        ...
        "prev" == n ? (u = t > o.first ? E($e(o, t - 1).text, null, l) : 0) : "add" == n ? (u = a + e.options.indentUnit) : "subtract" == n ? (u = a - e.options.indentUnit) : "number" == typeof n && (u = a + n), (u = Math.max(0, u));
        var h = "",
            d = 0;
        if (e.options.indentWithTabs) for (var f = Math.floor(u / l); f; --f) (d += l), (h += "\t");
        if ((d < u && (h += X(u - d)), h != c)) return qi(o, h, rt(t, 0), rt(t, c.length), "+input"), !(s.stateAfter = null);
        ...
        for (var h = e.curOp.updateInput, d = r.ranges.length - 1; 0 <= d; d--) {
            ...
            f.empty() &&
                (n && 0 < n
                    ? (p = rt(p.line, p.ch - n))
                    : e.state.overwrite && !s
                    ? (g = rt(g.line, Math.min($e(o, g.line).text.length, g.ch + Y(a).length)))
                    : s && dl && dl.lineWise && dl.text.join("\n") == a.join("\n") && (p = g = rt(p.line, 0)));
            g = { from: p, to: g, text: u ? u[d % u.length] : a, origin: i || (s ? "paste" : e.state.cutIncoming > l ? "cut" : "+input") };
            ji(e.doc, g), ln(e, "inputRead", e, g);
        }
        t && !s && ml(e, t), wr(e), e.curOp.updateInput < 2 && (e.curOp.updateInput = h), (e.curOp.typing = !0), (e.state.pasteIncoming = e.state.cutIncoming = -1);
    }
    function gl(e, t) {
        ...
        if (e.options.electricChars && e.options.smartIndent)
            for (var n = e.doc.sel, r = n.ranges.length - 1; 0 <= r; r--) {
                ...
                if (!(100 < i.head.ch || (r && n.ranges[r - 1].head.line == i.head.line))) {
                    ...
                    } else o.electricInput && o.electricInput.test($e(e.doc, i.head.line).text.slice(0, i.head.ch)) && (l = hl(e, i.head.line, "smart"));
    ...
    function bl() {
        ...
        return f ? (e.style.width = "1000px") : e.setAttribute("wrap", "off"), s && (e.style.border = "1px solid black"), yl(e), t;
    }
                ...
                (n =
                    "codepoint" == s
                        ? ((t = u.text.charCodeAt(o.ch + (0 < l ? 0 : -1))),
                          isNaN(t) ? null : ((n = 0 < l ? 55296 <= t && t < 56320 : 56320 <= t && t < 57343), new rt(o.line, Math.max(0, Math.min(u.text.length, o.ch + l * (n ? 2 : 1))), -l)))
                        : a
                        ? Eo(i.cm, u, o, l)
                        : Fo(u, o, l))
            ) {
                if (e || (r = o.line + c) < i.first || r >= i.first + i.size || ((o = new rt(r, o.ch, o.sticky)), !(u = $e(i, r)))) return;
    ...
    function xl(e, t, n, r) {
        ...
        for (
            "page" == r
                ? ((i = Math.min(e.display.wrapper.clientHeight, window.innerHeight || document.documentElement.clientHeight)), (i = Math.max(i - 0.5 * Yn(e.display), 3)), (o = (0 < n ? t.bottom : t.top) + n * i))
            ...
            if (o.node == r)
                return (function (u, e, t) {
                    ...
                    for (var f = o.previousSibling, p = t; f; f = f.previousSibling) {
                        if ((s = l(f, f.firstChild, -1))) return Sl(rt(s.line, s.ch + p), r);
    ...
    (e.prototype.init = function (e) {
        ...
        function n(e) {
            if (a(e) && !Ce(l, e)) {
                if (l.somethingSelected()) fl({ lineWise: !1, text: l.getSelections() }), "cut" == e.type && l.replaceSelection("", null, "cut");
                else {
                    ...
                    fl({ lineWise: !0, text: t.text }),
                        "cut" == e.type &&
                            l.operation(function () {
                                l.setSelections(t.ranges, 0, G), l.replaceSelection("", null, "cut");
                            });
                }
                if (e.clipboardData) {
                ...
                var r = bl(),
                    e = r.firstChild;
                l.display.lineSpace.insertBefore(r, l.display.lineSpace.firstChild), (e.value = dl.text.join("\n"));
                var i = A();
                H(e),
                    setTimeout(function () {
        ...
        (s.contentEditable = !0),
            yl(s, l.options.spellcheck, l.options.autocorrect, l.options.autocapitalize),
            ...
            if (t.display.viewTo == t.display.viewFrom || r.line >= t.display.viewTo || i.line < t.display.viewFrom) e.removeAllRanges();
                ...
                if (!o || o.bad || !n || n.bad || 0 != it(at(o, n), r) || 0 != it(st(o, n), i)) {
                    var n = t.display.view,
                        l = (r.line >= t.display.viewFrom && Cl(t, r)) || { node: n[0].measure.map[2], offset: 0 },
                        s = i.line < t.display.viewTo && Cl(t, i);
                    if ((s || (s = { node: (u = (u = n[n.length - 1].measure).maps ? u.maps[u.maps.length - 1] : u.map)[u.length - 1], offset: u[u.length - 2] - u[u.length - 3] }), l && s)) {
                        var a,
                        ...
                        a &&
                            (!d && t.state.focused ? (e.collapse(l.node, l.offset), a.collapsed || (e.removeAllRanges(), e.addRange(a))) : (e.removeAllRanges(), e.addRange(a)),
                            u && null == e.anchorNode ? e.addRange(u) : d && this.startGracePeriod()),
            ...
            if (null == this.readDOMTimeout && !this.gracePeriod && this.selectionChanged()) {
                ...
                this.composing ||
                    ...
                    e &&
                        t &&
                        Pr(r, function () {
                            Pi(r.doc, si(e, t), G), (e.bad || t.bad) && (r.curOp.selectionChanged = !0);
                        }));
            }
        }),
        (e.prototype.pollContent = function () {
            ...
            var e,
                ...
                r = r.to();
            if (
                (0 == i.ch && i.line > t.firstLine() && (i = rt(i.line - 1, $e(t.doc, i.line - 1).length)),
                r.ch == $e(t.doc, r.line).text.length && r.line < t.lastLine() && (r = rt(r.line + 1, 0)),
                i.line < n.viewFrom || r.line > n.viewTo - 1)
            )
                return !1;
            m = i.line == n.viewFrom || 0 == (m = er(t, i.line)) ? ((e = Je(n.view[0].line)), n.view[0].node) : ((e = Je(n.view[m].line)), n.view[m - 1].node.nextSibling);
            var o,
                r = er(t, r.line),
                r = r == n.view.length - 1 ? ((o = n.viewTo - 1), n.lineDiv.lastChild) : ((o = Je(n.view[r + 1].line) - 1), n.view[r + 1].node.previousSibling);
            if (!m) return !1;
            for (
            ...
            for (var a = 0, u = 0, c = l[0], h = s[0], d = Math.min(c.length, h.length); a < d && c.charCodeAt(a) == h.charCodeAt(a); ) ++a;
            for (var f = Y(l), p = Y(s), g = Math.min(f.length - (1 == l.length ? a : 0), p.length - (1 == s.length ? a : 0)); u < g && f.charCodeAt(f.length - u - 1) == p.charCodeAt(p.length - u - 1); ) ++u;
            if (1 == l.length && 1 == s.length && e == i.line) for (; a && a > i.ch && f.charCodeAt(f.length - u - 1) == p.charCodeAt(p.length - u - 1); ) a--, u++;
            (l[l.length - 1] = f.slice(0, f.length - u).replace(/^\u200b+/, "")), (l[0] = l[0].slice(a).replace(/\u200b+$/, ""));
            var m = rt(e, a),
                r = rt(o, s.length ? Y(s).length - u : 0);
            return 1 < l.length || l[0] || it(m, r) ? (qi(t.doc, l, m, r, "+input"), !0) : void 0;
        }),
        ...
        (e.prototype.onKeyPress = function (e) {
            0 == e.charCode || this.composing || (e.preventDefault(), this.cm.isReadOnly() || Er(this.cm, pl)(this.cm, String.fromCharCode(null == e.charCode ? e.keyCode : e.charCode), 0));
        }),
    ...
    (r.prototype.init = function (n) {
        ...
        function t(e) {
            if (!Ce(i, e)) {
                if (i.somethingSelected()) fl({ lineWise: !1, text: i.getSelections() });
                else {
                    if (!i.options.lineWiseCopyCut) return;
                    var t = vl(i);
                    fl({ lineWise: !0, text: t.text }), "cut" == e.type ? i.setSelections(t.ranges, null, G) : ((r.prevInput = ""), (o.value = t.text.join("\n")), H(o));
                }
        ...
        (r.prototype.showSelection = function (e) {
            ...
            T(t.cursorDiv, e.cursors), T(t.selectionDiv, e.selection), null != e.teTop && ((this.wrapper.style.top = e.teTop + "px"), (this.wrapper.style.left = e.teLeft + "px"));
        }),
        (r.prototype.reset = function (e) {
            ...
            this.contextMenuPending ||
                ...
                ((t = this.cm).somethingSelected()
                    ? ((this.prevInput = ""), (n = t.getSelection()), (this.textarea.value = n), t.state.focused && H(this.textarea), w && 9 <= v && (this.hasSelection = n))
                    : e || ((this.prevInput = this.textarea.value = ""), w && 9 <= v && (this.hasSelection = null)));
        }),
        ...
        (r.prototype.focus = function () {
            if ("nocursor" != this.cm.options.readOnly && (!h || A() != this.textarea))
                try {
                    this.textarea.focus();
                } catch (e) {}
        }),
        ...
        (r.prototype.poll = function () {
            ...
            if ((w && 9 <= v && this.hasSelection === i) || (g && /[\uf700-\uf7ff]/.test(i))) return t.display.input.reset(), !1;
            ...
            return (
                Pr(t, function () {
                    pl(t, i.slice(l), r.length - l, null, e.composing ? "*compose" : null),
        ...
        (r.prototype.onContextMenu = function (e) {
            ...
            function h() {
                ...
                null != o.selectionStart &&
                    ((t = "​" + ((e = r.somethingSelected()) ? o.value : "")), (o.value = "⇚"), (o.value = t), (n.prevInput = e ? "" : "​"), (o.selectionStart = 1), (o.selectionEnd = t.length), (i.selForContextMenu = r.doc.sel));
            }
            function d() {
                var e, t;
            ...
            u &&
                !p &&
                (r.options.resetSelectionOnContextMenu && -1 == r.doc.sel.contains(u) && Er(r, Pi)(r.doc, si(u), G),
                (l = o.style.cssText),
        ...
        Al("lineSeparator", null, function (e, r) {
            if ((e.doc.lineSep = r)) {
                ...
                for (var t = i.length - 1; 0 <= t; t--) qi(e.doc, r, i[t], rt(i[t].line, i[t].ch + r.length));
            }
        }),
        Al("specialChars", /[\u0000-\u001f\u007f-\u009f\u00ad\u061c\u200b\u200e\u200f\u2028\u2029\ufeff\ufff9-\ufffc]/g, function (e, t, n) {
            (e.state.specialChars = new RegExp(t.source + (t.test("\t") ? "" : "|\t"), "g")), n != il && e.refresh();
        }),
        Al(
        ...
        Al(
            ...
            !0,
            function (e, t) {
                (e.display.gutters.style.left = t ? qn(e.display) + "px" : "0"), e.refresh();
            },
            !0
        ),
        Al(
        ...
        Al(
            ...
            "native",
            function (e) {
                Dr(e), Nr(e), e.display.scrollbars.setScrollTop(e.doc.scrollTop), e.display.scrollbars.setScrollLeft(e.doc.scrollLeft);
            },
            !0
        ),
        Al(
        ...
        (Ml.prototype = {
            ...
            setOption: function (e, t) {
                var n = this.options,
                    r = n[e];
                (n[e] == t && "mode" != e) || ((n[e] = t), Nl.hasOwnProperty(e) && Er(this, Nl[e])(this, t, r), xe(this, "optionChange", this, e));
            },
            ...
            removeOverlay: Ir(function (e) {
                for (var t = this.state.overlays, n = 0; n < t.length; ++n) {
                    var r = t[n].modeSpec;
                    if (r == e || ("string" == typeof e && r.name == e)) return t.splice(n, 1), this.state.modeGen++, void tr(this);
                }
            }),
            indentLine: Ir(function (e, t, n) {
                "string" != typeof t && "number" != typeof t && (t = null == t ? (this.options.smartIndent ? "smart" : "prev") : t ? "add" : "subtract"), tt(this.doc, e) && hl(this, e, t, n);
            }),
            indentSelection: Ir(function (e) {
                for (var t = this.doc.sel.ranges, n = -1, r = 0; r < t.length; r++) {
                    var i = t[r];
                    if (i.empty()) i.head.line > n && (hl(this, i.head.line, e, !0), (n = i.head.line), r == this.doc.sel.primIndex && wr(this));
                    else {
                        for (var o = i.from(), l = i.to(), i = Math.max(n, o.line), n = Math.min(this.lastLine(), l.line - (l.ch ? 0 : 1)) + 1, s = i; s < n; ++s) hl(this, s, e);
            ...
            cursorCoords: function (e, t) {
                var n = this.doc.sel.primary(),
                    n = null == e ? n.head : "object" == typeof e ? ct(this.doc, e) : e ? n.from() : n.to();
            ...
            lineAtHeight: function (e, t) {
                return (e = zn(this, { top: e, left: 0 }, t || "page").top), et(this.doc, e + this.display.viewOffset);
            },
            heightAtLine: function (e, t, n) {
                var r,
                    i = !1,
                    e = "number" == typeof e ? ((r = this.doc.first + this.doc.size - 1), e < this.doc.first ? (e = this.doc.first) : r < e && ((e = r), (i = !0)), $e(this.doc, e)) : e;
                return In(this, e, { top: 0, left: 0 }, t || "page", n || i).top + (i ? this.doc.height - Vt(e) : 0);
            },
            ...
            addWidget: function (e, t, n, r, i) {
                ...
                (t.style.position = "absolute"),
                    ...
                    n && ((n = this), (t = { left: u, top: a, right: u + t.offsetWidth, bottom: a + t.offsetHeight }), null != (t = yr(n, t)).scrollTop && Lr(n, t.scrollTop), null != t.scrollLeft && Tr(n, t.scrollLeft));
            },
            ...
            moveV: Ir(function (r, i) {
                ...
                if (
                    (l.extendSelectionsBy(function (e) {
                        ...
                        var n = xl(o, t, r, i);
                        return "page" == i && e == l.sel.primary() && br(o, Rn(o, n, "div").top - t.top), n;
                    }, V),
                    s.length)
                )
            ...
            toggleOverwrite: function (e) {
                (null != e && e == this.state.overwrite) || (((this.state.overwrite = !this.state.overwrite) ? D : L)(this.display.cursorDiv, "CodeMirror-overwrite"), xe(this, "overwriteToggle", this, this.state.overwrite));
            },
            hasFocus: function () {
            ...
            getScrollInfo: function () {
                ...
                return { left: e.scrollLeft, top: e.scrollTop, height: e.scrollHeight - wn(this) - this.display.barHeight, width: e.scrollWidth - wn(this) - this.display.barWidth, clientHeight: Cn(this), clientWidth: xn(this) };
            },
            ...
            setSize: Ir(function (e, t) {
                ...
                var r = this;
                null != e && (this.display.wrapper.style.width = n(e)), null != t && (this.display.wrapper.style.height = n(t)), this.options.lineWrapping && Wn(this);
            ...
            refresh: Ir(function () {
                ...
                tr(this),
                    ...
                    jr(this.display),
                    (null == e || 0.5 < Math.abs(e - Yn(this.display)) || this.options.lineWrapping) && Qn(this),
                    xe(this, "refresh", this);
            }),
    ...
    return (
        ...
        (ul.defineMode = function (e) {
            ul.defaults.mode || "null" == e || (ul.defaults.mode = e),
                function (e, t) {
                    2 < arguments.length && (t.dependencies = Array.prototype.slice.call(arguments, 2)), (Re[e] = t);
        ...
        (ul.fromTextArea = function (t, n) {
            ...
            if (
                ...
                null == n.autofocus && ((e = A()), (n.autofocus = e == t || (null != t.getAttribute("autofocus") && e == document.body))),
                ...
                (e.save = r),
                    ...
                    (e.toTextArea = function () {
                        (e.toTextArea = isNaN),
                            ...
                            (t.style.display = ""),
                            t.form && (we(t.form, "submit", r), n.leaveSubmitMethodAlone || "function" != typeof t.form.submit || (t.form.submit = o));
                    });
            }),
