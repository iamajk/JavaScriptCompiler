!(function (t) {
    ...
    function i(o, t) {
        ...
        for (
            var i = this,
                ...
                e = (l.setAttribute("role", "listbox"), l.setAttribute("aria-expanded", "true"), (l.id = this.id), o.cm.options.theme),
                n = ((l.className = "CodeMirror-hints " + e), (this.selectedHint = t.selectedHint || 0), t.list),
                h = 0;
            h < n.length;
            ++h
        ) {
        ...
        var f,
            ...
            b =
                (e !== c.body &&
                    ((b = (H = -1 !== ["absolute", "relative", "fixed"].indexOf(r.getComputedStyle(e).position) ? e : e.offsetParent).getBoundingClientRect()),
                    (A = c.body.getBoundingClientRect()),
                    (y = b.left - A.left - H.scrollLeft),
                    (w = b.top - A.top - H.scrollTop)),
                (l.style.left = m - y + "px"),
                (l.style.top = g - w + "px"),
                r.innerWidth || Math.max(c.body.offsetWidth, c.documentElement.offsetWidth)),
            ...
            e = !!o.options.paddingForScrollbar && l.scrollHeight > l.clientHeight + 1;
        setTimeout(function () {
            f = s.getScrollInfo();
        });
        0 < H.bottom - A &&
            ((S = H.bottom - H.top), (k = H.top - (p.bottom - p.top) - 2), A - H.top < k ? (k < S && (l.style.height = (S = k) + "px"), (l.style.top = (g = p.top - S) + w + "px"), (v = !1)) : (l.style.height = A - H.top - 2 + "px"));
        var C,
            k = H.right - b;
        if ((e && (k += s.display.nativeBarWidth), 0 < k && (H.right - H.left > b && ((l.style.width = b - 5 + "px"), (k -= H.right - H.left - b)), (l.style.left = (m = Math.max(p.left - k - y, 0)) + "px")), e))
            for (var x = l.firstChild; x; x = x.nextSibling) x.style.paddingRight = s.display.nativeBarWidth + "px";
        s.addKeyMap(
        ...
        var S = this.getSelectedHintRange();
        return (0 === S.from && 0 === S.to) || this.scrollToActive(), T.signal(t, "select", n[this.selectedHint], l.childNodes[this.selectedHint]), !0;
    }
    function r(t, e, i, n) {
    ...
    (n.prototype = {
        ...
        cursorActivity: function () {
            ...
            i.line != this.startPos.line || n.length - i.ch != this.startLen - this.startPos.ch || i.ch < e.ch || this.cm.somethingSelected() || !i.ch || this.options.closeCharacters.test(n.charAt(i.ch - 1))
                ? this.close()
        ...
        (i.prototype = {
            ...
            scrollToActive: function () {
                ...
                e.offsetTop < this.hints.scrollTop
                    ...
                    : t.offsetTop + t.offsetHeight > this.hints.scrollTop + this.hints.clientHeight && (this.hints.scrollTop = t.offsetTop + t.offsetHeight - this.hints.clientHeight + i.offsetTop);
            },
        ...
        T.registerHelper("hint", "fromList", function (t, e) {
            for (
                var i,
                    n = t.getCursor(),
                    t = t.getTokenAt(n),
                    o = T.Pos(n.line, t.start),
                    s = n,
                    c = (t.start < n.ch && /\w/.test(t.string.charAt(n.ch - t.start - 1)) ? (i = t.string.substr(0, n.ch - t.start)) : ((i = ""), (o = n)), []),
                    r = 0;
                r < e.words.length;
                r++
            ) {
